...
#         print('prediction: ', pred)
        ...
        current_correct = torch.sum(torch.squeeze(pred.eq(target.data.view_as(pred))).cpu())
#         print('Iteration accuracy: {:.3f}'.format(current_correct * 100 / data.size(0)))
    ...
    print('Total epoch training accuracy: {:.3f}'.format(correct * 100 / total))

    return train_loss, correct * 100 / total
...
#             print('target: ', target)
    ...
    return valid_loss, correct * 100 / total
